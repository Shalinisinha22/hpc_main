...
export default function PrivacyPolicy() {
  return (
    ...
    <div className="bg-white/95 border border-amber-200 rounded-2xl shadow-2xl p-4 md:p-10 max-w-4xl mx-auto relative">
          <div className="prose max-w-none prose-amber prose-h1:text-[#bf840d] prose-h2:text-[#bf840d] prose-h3:text-[#bf840d]">
            ...
            <h2>THE HOTEL PATLIPUTRA CONTINENTAL LLP Privacy Policy</h2>
            <p>At HOTEL PATLIPUTRA CONTINENTAL LLP we endeavour to provide our guests outstanding services and experiences in our hotels and luxury residences around the world. We value your business and your faith in us in delivering you a superior level of service.<br />
            ...
            <h3>YOUR CONSENT</h3>
            <p>We request you to carefully read this Privacy Policy and Terms and Conditions under the Legal tab before sharing personal information with us. By visiting our websites, we assume, your acceptance of the practices described in this policy document.</p>

            <h3>SHOULD YOU WANT TO OPT-OUT</h3>
            <p>If we possess your contact information, we may want to keep you posted about our products, services, and events, through email. Should you prefer not to keep up to date with HOTEL PATLIPUTRA CONTINENTAL LLP news and latest information on services and receive such marketing materials, please send an email to.<br />
            ...
            <p>We do not knowingly collect information related to your racial or ethnic origin, political opinions, religious or other beliefs, health, criminal background or political affiliations unless it is volunteered by you.</p>

            <p>This Privacy Policy covers the following areas relating to the privacy of information provided by you:</p>
            <ul>
            ...
            <h3>LINKS to WEBSITES OF THIRD PARTY MARKETERS</h3>
