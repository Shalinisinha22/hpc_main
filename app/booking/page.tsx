...
export default function BookingPage() {
  ...
  const roomPrice = Number(searchParams.get("roomPrice")) || 199
  const roomImage = searchParams.get("roomImage") || "/placeholder.svg?height=400&width=600"
  ...
  const taxesAndFees = basePrice * 0.18 // 18% tax
          ...
          <div className="container mx-auto px-4 max-w-3xl">
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              ...
              <div className="bg-amber-50 p-6 rounded-lg mb-6">
                <h2 className="text-xl font-medium text-amber-900 mb-4">Booking Details</h2>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-1">
                          ...
                          <div>
                            <select id="children" className="w-full p-2 border border-gray-300 rounded-md">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex gap-4 mb-4">
                    <div className="relative w-24 h-24 rounded-md overflow-hidden flex-shrink-0">
                      <Image src={roomImage || "/placeholder.svg"} alt={roomName} fill className="object-cover" />
                    </div>
                    <div>
                      <h3 className="font-medium text-lg">{roomName}</h3>
                      ...
                      <p className="text-sm text-gray-500">
                        {guests} Guests • {nights} {nights === 1 ? "Night" : "Nights"}
                      </p>
                    </div>
                  </div>
